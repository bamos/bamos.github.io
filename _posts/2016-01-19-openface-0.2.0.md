...
See our [release notes](http://cmusatyalab.github.io/openface/release-notes/#020-20161015)
...
on our Telsa K40 GPU with 12GB of memory.
...
The Inception layers refer to the
[Going Deeper with Convolutions](http://www.cv-foundation.org/openaccess/content_cvpr_2015/ext/1A_001_ext.pdf)
paper.
...
build.
I could have switched OpenFace to a Docker repository and
manually built and pushed instead of automated build, but I like
...
A slight problem is that the latest pre-build Docker container
...
The OpenFace 0.1.1 model is 966MB, even though it only
