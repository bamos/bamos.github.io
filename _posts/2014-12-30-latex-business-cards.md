...
Graphical programs and companies provide business card design
and printing services, but this post introduces my simple
business card template with the [LaTeX](http://www.latex-project.org/)
typesetting system.
LaTeX is traditionally used for high-quality technical documents
and this is my attempt at using it for business cards.

I've added this business card template to my
[bamos/latex-templates](https://github.com/bamos/latex-templates)
project, which now contains ten simple LaTeX templates.
Browse the source directory at
...
package
to place the cards on the document
and
the
...
and see the PDF [here](/data/2014-12-30/business-cards.pdf).
